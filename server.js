...
const onProxyReq = (proxyReq, req, res, options) => {
  ...
  proxyReq.setHeader('Authorization', "Bearer AAAAAAAAAAAAAAAAAAAAAC3DiwEAAAAAoFXXHhZJdvYDhOI9cfqbOPvnR2M%3DvN15pnYANMOuwig23Ou1zyT7JRdvgWIxdFV8axagCwyGnDBUf5");
